...
echo ""
echo "──────────────────────────────────────────────"
echo "  Want to capture what you build over time?"
echo ""
echo "  The Session Mirror remembers your sessions"
echo "  so your next one starts where this one left off."
echo ""
echo "  bash install-practitioner.sh"
echo "──────────────────────────────────────────────"
echo ""
